...
do
  case $opt in 
    "EUROPE1")
      ...
      curl -s -o $file $website${urls[0]} && unzip -qq -d "EUROPE1" $file
      cd EUROPE1/
      choose_vpn
      break
    ;;
    "EUROPE2")
      ...
      curl -s -o $file $website${urls[1]} && unzip -qq -d "EUROPE2" $file
      cd EUROPE2/
      choose_vpn
      break
    ;;
    "USA1")
      ...
      curl -s -o $file $website${urls[2]} && unzip -qq -d "USA1" $file
      cd USA1/
      choose_vpn
      break
    ;;
    "USA2")
      ...
      curl -s -o $file $website${urls[3]} && unzip -qq -d "USA2" $file
      cd USA2/
      choose_vpn
      break
    ;;
    "CANADA")
      ...
      curl -s -o $file $website${urls[4]} && unzip -qq -d "CANADA" $file
      cd CANADA/
      choose_vpn
      break
    ;;
    "GERMANY")
      ...
      curl -s -o $file $website${urls[5]} && unzip -qq -d "GERMANY" $file
      cd GERMANY/
      choose_vpn
      break
    ;;
